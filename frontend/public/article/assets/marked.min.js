...
!(function (e, t) {
  ...
  function u(n, e) {
    ...
    const s = {
      replace: (e, t) => (
        (t = (t = 'object' == typeof t && 'source' in t ? t.source : t).replace(
          p,
          '$1'
        )),
        (n = n.replace(e, t)),
  ...
  function k(e, t, n) {
    if (e) {
      let e;
      try {
        e = decodeURIComponent(z(n)).replace(g, '').toLowerCase();
      } catch (e) {
        return null;
      }
      if (
  ...
  function b(e, t) {
    ...
    if (
      (n[0].trim() || n.shift(),
      0 < n.length && !n[n.length - 1].trim() && n.pop(),
      n.length > t)
    )
      n.splice(t);
  ...
  function y(e, t, n, s) {
    ...
    return '!' !== e[0].charAt(0)
      ? ((s.state.inLink = !0),
        ...
        (s.state.inLink = !1),
        e)
      : { type: 'image', raw: n, href: r, title: t, text: h(i) };
  }
  class _ {
    options;
    rules;
      ...
      if (e)
        return (
          (t = e[0].replace(/^ {1,4}/gm, '')),
          {
            ...
            text: this.options.pedantic ? t : w(t, '\n'),
          }
        );
    }
    fences(e) {
        ...
        return (
          (n = (function (e, t) {
            ...
            return t
              ...
              .map((e) => {
                var t = e.match(/^\s+/);
                return null !== t && (([t] = t), t.length >= n.length)
                  ? e.slice(n.length)
                  : e;
              })
              .join('\n');
      ...
      if (d) {
        ...
        for (
          var k = 1 < u.length,
            ...
            x =
              ((u = k ? '\\d{1,9}\\' + u.slice(-1) : '\\' + u),
              this.options.pedantic && (u = k ? u : '[*+-]'),
              new RegExp(`^( {0,3}${u})((?:[	 ][^\\n]*)?(?:\\n|$))`));
          ...
          if (
            ...
            this.options.pedantic
              ? ((s = 2), (c = a.trimLeft()))
              : ((s = 4 < (s = d[2].search(/[^ ]/)) ? 1 : s),
                (c = a.slice(s)),
                (s += d[1].length)),
            (i = !1),
            !a &&
              /^ *$/.test(o) &&
              ((e += o + '\n'), (g = g.substring(o.length + 1)), (p = !0)),
            !p)
          )
            for (
              var m = new RegExp(
                ...
                w = new RegExp(`^ {0,${Math.min(3, s - 1)}}(?:\`\`\`|~~~)`),
                y = new RegExp(`^ {0,${Math.min(3, s - 1)}}#`);
              g &&
              ((h = g.split('\n', 1)[0]),
              (o = h),
              this.options.pedantic &&
              ...
              i || o.trim() || (i = !0),
                (e += h + '\n'),
                (g = g.substring(h.length + 1)),
                (a = o.slice(s));
            }
          f.loose || (l ? (f.loose = !0) : /\n *\n *$/.test(e) && (l = !0)),
            this.options.gfm &&
              (t = /^\[[ xX]\] /.exec(c)) &&
              ((n = '[ ] ' !== t[0]), (c = c.replace(/^\[[ xX]\] +/, ''))),
            f.items.push({
              type: 'list_item',
              raw: e,
              task: !!t,
        ...
        for (r = 0; r < $; r++)
          (this.lexer.state.top = !1),
            (f.items[r].tokens = this.lexer.blockTokens(f.items[r].text, [])),
            f.loose ||
              ((_ =
                0 <
                  (_ = f.items[r].tokens.filter((e) => 'space' === e.type))
                    .length && _.some((e) => /\n.*\n/.test(e.raw))),
              (f.loose = _));
        if (f.loose) for (r = 0; r < $; r++) f.items[r].loose = !0;
        return f;
      }
    }
    html(e) {
        ...
        return (
          ...
          (s =
            ...
            e[3]
              ...
              .replace(this.rules.inline._escapes, '$1')),
          { type: 'def', tag: t, raw: e[0], href: n, title: s }
        );
    }
    table(i) {
        ...
        if (l.header.length === l.align.length) {
          ...
          for (t = 0; t < e; t++)
            /^ *-+: *$/.test(l.align[t])
              ...
              ? (l.align[t] = 'left')
              : (l.align[t] = null);
          for (e = l.rows.length, t = 0; t < e; t++)
            l.rows[t] = b(l.rows[t], l.header.length).map((e) => ({ text: e }));
          for (e = l.header.length, n = 0; n < e; n++)
            l.header[n].tokens = this.lexer.inline(l.header[n].text);
          for (e = l.rows.length, n = 0; n < e; n++)
            for (r = l.rows[n], s = 0; s < r.length; s++)
    ...
    link(n) {
      ...
      if (n) {
        ...
        if (!this.options.pedantic && /^</.test(s)) {
          ...
          -1 < r &&
            ((i = (0 === n[0].indexOf('!') ? 5 : 4) + n[1].length + r),
              ...
              href:
                (e = /^</.test(e)
                  ? this.options.pedantic && !/>$/.test(s)
                    ? e.slice(1)
                    : e.slice(1, -1)
                  : e) && e.replace(this.rules.inline._escapes, '$1'),
    ...
    reflink(t, n) {
      ...
      if (
        (s =
          ...
          this.rules.inline.nolink.exec(t))
      ) {
        let e = (s[2] || s[1]).replace(/\s+/g, ' ');
        return (e = n[e.toLowerCase()])
          ? y(s, e, s[0], this.lexer)
          : { type: 'text', raw: (t = s[0].charAt(0)), text: t };
      }
    }
    emStrong(r, i, e = '') {
      ...
      if (
        ...
        for (
          c.lastIndex = 0, i = i.slice(-1 * r.length + a);
          null != (l = c.exec(i));
    ...
    codespan(t) {
      ...
      if (t) {
        ...
        var n = /[^ ]/.test(e),
          s = /^ /.test(e) && / $/.test(e);
        return (
          (e = h((e = n && s ? e.substring(1, e.length - 1) : e), !0)),
    ...
    autolink(n, s) {
      ...
      if (n) {
        ...
        return (
          (t =
            '@' === n[2]
              ? 'mailto:' + (e = h(this.options.mangle ? s(n[1]) : n[1]))
              : (e = h(n[1]))),
          {
            type: 'link',
            raw: n[0],
    ...
    url(e, n) {
      ...
      if ((s = this.rules.inline.url.exec(e))) {
        let e, t;
        if ('@' === s[2])
          (e = h(this.options.mangle ? n(s[0]) : s[0])), (t = 'mailto:' + e);
        else {
          for (
            ;
            (r = s[0]),
              (s[0] = this.rules.inline._backpedal.exec(s[0])[0]),
              r !== s[0];

          );
          (e = h(s[0])), (t = 'www.' === s[1] ? 'http://' + s[0] : s[0]);
        }
        return {
          type: 'link',
          raw: s[0],
          ...
          (e = this.lexer.state.inRawBlock
            ? this.options.sanitize
              ? this.options.sanitizer
                ...
                : h(t[0])
              : t[0]
            : h(this.options.smartypants ? n(t[0]) : t[0])),
  ...
  const $ = {
    ...
    v =
      ...
      ($.html = u($.html, 'i')
        ...
        .getRegex()),
      ($.lheading = u($.lheading).replace(/bull/g, $.bullet).getRegex()),
  ...
  function S(e) {
    ...
    for (n = 0; n < r; n++)
      (s = e.charCodeAt(n)),
        0.5 < Math.random() && (s = 'x' + s.toString(16)),
        (t += '&#' + s + ';');
    return t;
  }
  (v._punctuation = '\\p{P}$+<=>`^|~'),
    (v.punctuation = u(v.punctuation, 'u')
      .replace(/punctuation/g, v._punctuation)
      .getRegex()),
    (v.blockSkip = /\[[^[\]]*?\]\([^\(\)]*?\)|`[^`]*?`|<[^<>]*?>/g),
    (v.anyPunctuation = /\\[punct]/g),
    (v._escapes = /\\([punct])/g),
    (v._comment = u($._comment).replace('(?:--\x3e|$)', '--\x3e').getRegex()),
    (v.emStrong.lDelim = u(v.emStrong.lDelim, 'u')
      .replace(/punct/g, v._punctuation)
      .getRegex()),
    (v.emStrong.rDelimAst = u(v.emStrong.rDelimAst, 'gu')
      .replace(/punct/g, v._punctuation)
      .getRegex()),
    (v.emStrong.rDelimUnd = u(v.emStrong.rDelimUnd, 'gu')
      .replace(/punct/g, v._punctuation)
      .getRegex()),
    (v.anyPunctuation = u(v.anyPunctuation, 'gu')
      .replace(/punct/g, v._punctuation)
      .getRegex()),
    (v._escapes = u(v._escapes, 'gu')
      .replace(/punct/g, v._punctuation)
      .getRegex()),
    ...
    (v.reflink = u(v.reflink)
      ...
      .replace('ref', $._label)
      .getRegex()),
    (v.nolink = u(v.nolink).replace('ref', $._label).getRegex()),
  ...
  class R {
    ...
    constructor(e) {
      ...
      e = { block: $.normal, inline: v.normal };
      this.options.pedantic
        ? ((e.block = $.pedantic), (e.inline = v.pedantic))
        : this.options.gfm &&
          ((e.block = $.gfm),
        ...
        if (
          !(
            ...
            this.options.extensions.block.some(
              (e) =>
                !!(n = e.call({ lexer: this }, s, t)) &&
                ((s = s.substring(n.raw.length)), t.push(n), !0)
            )
          )
        )
          if ((n = this.tokenizer.space(s)))
            (s = s.substring(n.raw.length)),
              1 === n.raw.length && 0 < t.length
                ? (t[t.length - 1].raw += '\n')
                : t.push(n);
          ...
          else if ((n = this.tokenizer.fences(s)))
            (s = s.substring(n.raw.length)), t.push(n);
          else if ((n = this.tokenizer.heading(s)))
            (s = s.substring(n.raw.length)), t.push(n);
          else if ((n = this.tokenizer.hr(s)))
            (s = s.substring(n.raw.length)), t.push(n);
          else if ((n = this.tokenizer.blockquote(s)))
            (s = s.substring(n.raw.length)), t.push(n);
          else if ((n = this.tokenizer.list(s)))
            (s = s.substring(n.raw.length)), t.push(n);
          else if ((n = this.tokenizer.html(s)))
            (s = s.substring(n.raw.length)), t.push(n);
            ...
            (s = s.substring(n.raw.length)),
              ...
              ('paragraph' !== e.type && 'text' !== e.type)
                ...
                : ((e.raw += '\n' + n.raw),
                  (e.text += '\n' + n.raw),
                  (this.inlineQueue[this.inlineQueue.length - 1].src = e.text));
          else if ((n = this.tokenizer.table(s)))
            (s = s.substring(n.raw.length)), t.push(n);
          else if ((n = this.tokenizer.lheading(s)))
            (s = s.substring(n.raw.length)), t.push(n);
          else {
            if (
              ((r = s),
              ...
              this.options.extensions.startBlock.forEach((e) => {
                'number' == typeof (n = e.call({ lexer: this }, a)) &&
                  0 <= n &&
                  (t = Math.min(t, n));
              }),
          ...
          if ((n = this.tokenizer.escape(s)))
            ...
            (s = s.substring(n.raw.length)),
              (e = t[t.length - 1]) && 'text' === n.type && 'text' === e.type
                ...
                : t.push(n);
          else if ((n = this.tokenizer.link(s)))
            (s = s.substring(n.raw.length)), t.push(n);
            ...
            (s = s.substring(n.raw.length)),
              (e = t[t.length - 1]) && 'text' === n.type && 'text' === e.type
                ? ((e.raw += n.raw), (e.text += n.text))
                : t.push(n);
          else if ((n = this.tokenizer.emStrong(s, i, o)))
            (s = s.substring(n.raw.length)), t.push(n);
          else if ((n = this.tokenizer.codespan(s)))
            (s = s.substring(n.raw.length)), t.push(n);
          else if ((n = this.tokenizer.br(s)))
            (s = s.substring(n.raw.length)), t.push(n);
          else if ((n = this.tokenizer.del(s)))
            (s = s.substring(n.raw.length)), t.push(n);
          else if ((n = this.tokenizer.autolink(s, S)))
            (s = s.substring(n.raw.length)), t.push(n);
          else if (!this.state.inLink && (n = this.tokenizer.url(s, S)))
            (s = s.substring(n.raw.length)), t.push(n);
          else {
            if (
              ((r = s),
              ...
              this.options.extensions.startInline.forEach((e) => {
                'number' == typeof (n = e.call({ lexer: this }, p)) &&
                  0 <= n &&
                  (t = Math.min(t, n));
              }),
                t < 1 / 0 && 0 <= t && (r = s.substring(0, t + 1));
            }
            if ((n = this.tokenizer.inlineText(r, j)))
              (s = s.substring(n.raw.length)),
...
`;
    ...
    heading(e, t, n, s) {
      return this.options.headerIds
        ? `<h${t} id="${this.options.headerPrefix + s.slug(n)}">${e}</h${t}>
`
        : `<h${t}>${e}</h${t}>
`;
    }
...
`
  ...
  class I {
    ...
    getNextSafeSlug(e, t) {
      ...
      if (this.seen.hasOwnProperty(n))
        for (
          s = this.seen[e];
          s++, (n = e + '-' + s), this.seen.hasOwnProperty(n);
          ...
          switch (u.type) {
            ...
            case 'heading':
              n += this.renderer.heading(
                ...
                u.depth,
                z(this.parseInline(u.tokens, this.textRenderer)),
                this.slugger
              );
              continue;
            case 'code':
            ...
            case 'table':
              ...
              for (
                ...
                for (o = u.rows[r], h = '', a = o.length, i = 0; i < a; i++)
                  h += this.renderer.tablecell(this.parseInline(o[i].tokens), {
                    header: !1,
                    align: u.align[i],
                  });
            ...
            case 'list':
              for (
                ...
                (m = (x = u.items[r]).checked),
                  ...
                  (p += this.renderer.listitem(f, b, !!m));
  ...
  class Z {
    ...
    parse = this.#parseMarkdown(R.lex, E.parse);
    parseInline = this.#parseMarkdown(R.lexInline, E.parseInline);
    Parser = E;
    parser = E.parse;
    Renderer = T;
    TextRenderer = A;
        ...
        switch (((n = n.concat(t.call(this, s))), s.type)) {
          ...
          default:
            ...
            this.defaults.extensions.childTokens[s.type]
              ? this.defaults.extensions.childTokens[s.type].forEach((e) => {
    ...
    use(...e) {
      ...
      return (
        e.forEach((n) => {
            ...
            n.extensions &&
              (n.extensions.forEach((n) => {
                ...
                if ('tokenizer' in n) {
                  ...
                  t[n.level]
                    ? t[n.level].unshift(n.tokenizer)
                    : (t[n.level] = [n.tokenizer]),
                    n.start &&
                      ('block' === n.level
                        ? t.startBlock
                          ? t.startBlock.push(n.start)
                          : (t.startBlock = [n.start])
                        : 'inline' === n.level &&
                          (t.startInline
                            ? t.startInline.push(n.start)
                            : (t.startInline = [n.start])));
                }
                'childTokens' in n &&
                  n.childTokens &&
                  (t.childTokens[n.name] = n.childTokens);
              }),
              (e.extensions = t)),
            n.renderer)
          ) {
          ...
          if (n.tokenizer) {
            const l = this.defaults.tokenizer || new _(this.defaults);
          ...
          if (n.hooks) {
            const h = this.defaults.hooks || new P();
            for (const c in n.hooks) {
              const p = h[c];
              P.passThroughHooks.has(c)
                ? (h[c] = (e) => {
                    return this.defaults.async
                      ? Promise.resolve(n.hooks[c].call(h, e)).then((e) =>
                          p.call(h, e)
                        )
                      : ((e = n.hooks[c].call(h, e)), p.call(h, e));
                  })
                : (h[c] = (...e) => {
    ...
    #parseMarkdown(h, c) {
      return (t, e, r) => {
        ...
        const i = { ...this.defaults, ...e },
          l = this.#onError(!!i.silent, !!i.async, r);
        if (null == t)
            ...
            if (!t)
              try {
                i.walkTokens && this.walkTokens(n, i.walkTokens),
                  (e = c(n, i)),
                  i.hooks && (e = i.hooks.postprocess(e));
              } catch (e) {
                t = e;
              }
        ...
        if (
          ...
          return (
            (t =
              ...
              h(e.message + '', !0) +
              '</pre>'),
            s ? Promise.resolve(t) : r ? void r(null, t) : t
          );
  ...
  const q = new Z();
  function L(e, t, n) {
    return q.parse(e, t, n);
  }
  (L.options = L.setOptions =
    function (e) {
      return q.setOptions(e), n((L.defaults = q.defaults)), L;
    }),
    (L.getDefaults = e),
    (L.defaults = t.defaults),
    (L.use = function (...e) {
      return q.use(...e), n((L.defaults = q.defaults)), L;
    }),
